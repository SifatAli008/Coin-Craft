@echo off
echo ==============================================
echo CoinCraft Google Parent Login Demo
echo ==============================================
echo.
...
echo Starting Google Parent Login Demo...
echo.
set MAIN_CLASS=com.coincraft.ui.GoogleParentLoginDemo
